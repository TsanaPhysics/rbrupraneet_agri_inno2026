...
<head>
    ...
    <title>Poster - Praneet Wittayakom</title>
    <!-- Fonts -->
...
<div class="poster-container">
    ...
    <div class="header-graphic">
        ...
        <div class="school-badge">📍 โรงเรียนประณีตวิทยาคม</div>
    </div>
    ...
    <div class="cta-section">
        <div style="display: flex; align-items: center; justify-content: center; gap: 30px;">
            ...
            <div style="text-align: left;">
                <p class="footer-text">✨ ด่วน! รับจำนวนจำกัดสำหรับนักเรียนประณีตวิทยาคม</p>
                <p style="color: var(--primary); font-weight: bold; font-size: 1.2rem; margin-top: 5px;">ฟรีตลอดหลักสูตร พร้อมใบประกาศนียบัตร</p>
