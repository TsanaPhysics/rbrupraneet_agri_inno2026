...
<head>
    ...
    <title>ePocketbook: Climate Hacking 2026 | Technical Documentary</title>
    ...
    <style>
        ...
        * {
        ...
        .cover {
            height: 100vh;
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.9)), url('assets/images/manual_cover_art.png');
...
<body>
    ...
    <div class="pocketbook">
        ...
        <!-- PAGE 00: COVER PAGE -->
        <section class="cover">
            <div class="cover-vol">Vol. 01 | No. 2026 | AIDA xAI Center</div>
            <h1 class="cover-title">Climate<br>Hacking</h1>
        ...
        <section class="page">
            ...
            <h2 class="mag-title">ยินดีต้อนรับสู่พรมแดนใหม่ของเกษตรกรรมดิจิทัล</h2>

            <div class="magazine-columns">
                <p>
                    <span class="thai-dropcap">ใ</span>นยุคที่สภาพภูมิอากาศแปรปรวนกลายเป็นโจทย์ท้าทายหลักของมวลมนุษยชาติ
                    เทคโนโลยีไม่ได้เป็นเพียงเครื่องมือที่มีไว้เพื่อความสะดวกสบายอีกต่อไป แต่คือ "กุญแจสำคัญ"
                    ในการอยู่รอดและพัฒนาอย่างยั่งยืน โครงการ RBRU-Praneet
                    ขอนำเสนอมุมมองใหม่ที่จะเปลี่ยนเกษตรกรไทยให้กลายเป็น Digital Farmer
                    รุ่นเยาว์ที่พร้อมรับมือกับความผันผวนของโลก
                </p>
                <p>
                    คู่มือฉบับนี้ไม่ใช่เพียงหนังสือสอนเขียนโค้ด แต่คือ "Tech Documentary"
                    ที่จะพาคุณไปสัมผัสเบื้องหลังการนำภาษา Python มาวิเคราะห์หยาดฝน ทิศทางลม
                    และความร้อนสะสมในสวนทุเรียนเมืองจันท์
                    เพื่อให้ภูมิปัญญาท้องถิ่นเต้นเป็นจังหวะเดียวกับอัลกอริทึมที่แม่นยำที่สุด
                </p>
            </div>

            <div class="pull-quote">
                "Data is the new soil; Python is the new plough. We are not just farming crops; we are farming
                insights."
            </div>
        ...
        <section class="page">
            ...
            <h2 class="mag-title">Cloud Lab: พลังเตรียมความพร้อมบนฟากฟ้า</h2>

            <div class="cloud-lab-hero">
                <div>
                    <h3 style="font-size: 2rem; font-weight: 900; margin-bottom: 1rem;">Powered by Google Colab</h3>
                    <p style="max-width: 500px; font-weight: 300;">เข้าถึงพลังการประมวลผลระดับโลกได้จากห้องเรียนของคุณ
                        ไม่ต้องติดตั้งซอฟต์แวร์ให้ยุ่งยาก</p>
                </div>
            </div>

            <div class="magazine-columns">
                <p>
                    หัวใจของการเรียนรู้ในศตวรรษที่ 21 คือความยืดหยุ่น โครงการของเราเลือกใช้ <strong>Google
                        Colab</strong> เป็นแพลตฟอร์มหลัก เพราะนักเรียนสามารถเข้าถึงเครื่องมือ Data Science
                    ระดับโลกได้ผ่านเพียงแค่เบราว์เซอร์
                </p>
                <p>
                    <strong>วิธีการเริ่มต้น:</strong><br>
                    1. ล็อกอินด้วย Google Account<br>
                    2. เชื่อมต่อ GitHub Repo ของ RBRU-Praneet<br>
                    3. รันโค้ดบนระบบ Cloud ได้ทันที!<br><br>
                    <em>เคล็ดลับความสำคัญ: อย่ากลัวที่จะลองเปลี่ยนตัวเลขในโค้ด ภาษา Python
                        จะเก่งขึ้นได้จากการลองชำแหละผลลัพธ์</em>
                </p>
            </div>
            ...
            <div class="tech-insight">
                ...
                <ul style="padding-left: 1.5rem; font-size: 0.9rem;">
                    ...
                    <li>Dataset: <code>chanthaburi_climate_sample.csv</code></li>
                    <li>Curiosity for Agri-Innovation</li>
                </ul>
            </div>
        </section>
