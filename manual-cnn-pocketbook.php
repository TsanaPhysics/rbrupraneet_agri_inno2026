...
<head>
    ...
    <title>ePocketbook: CNN Plant Disease 2026 | Technical Documentary</title>
    ...
    <style>
        ...
        * {
        ...
        .cover {
            height: 100vh;
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.9)), url('assets/images/activities/cnn_plant_lab.png');
...
<body>
    ...
    <div class="pocketbook">
        ...
        <!-- PAGE 00: COVER PAGE -->
        <section class="cover">
            <div class="cover-vol">Vol. 02 | No. 2026 | AIDA xAI Center</div>
            <h1 class="cover-title" style="font-size: 5rem;">Computer<br>Vision AI</h1>
            ...
            <div class="cover-footer">
                <div class="footer-sub">Center for AI Innovation & Development in Agriculture and Environment</div>
                <div class="footer-main">AIDA xAI Center 2026 : SciRBRU AgriEnvi DeepTech Teams</div>
        ...
        <section class="page">
            ...
            <h2 class="mag-title">ยินดีต้อนรับสู่ดวงตาปัญญาประดิษฐ์ทางการเกษตร</h2>

            <div class="magazine-columns">
                <p>
                    <span class="thai-dropcap">ใ</span>นยุคที่การเกษตรต้องการความแม่นยำและตอบสนองอย่างรวดเร็ว
                    เทคโนโลยีด้าน Computer Vision ไม่ได้เป็นเพียงนวัตกรรมสงวนสิทธิ์สำหรับห้องปฏิบัติการล้ำยุคอีกต่อไป
                    แต่คือ "เนตรสวรรค์อัจฉริยะ" ที่ช่วยให้เกษตรกรมองเห็นสิ่งผิดปกติเล็กๆ บนใบพืช
                    ก่อนที่ความเสียหายจะแพร่กระจาย โครงการ RBRU-Praneet พร้อมติดอาวุธทางปัญญาให้นักเรียนก้าวสู่การเป็น
                    AI Vision Engineer รุ่นเยาว์
                </p>
                <p>
                    คู่มือฉบับนี้จะพาคุณเจาะลึกเบื้องหลังโค้ดดิ้งของการสร้างหุ่นยนต์ที่มีสายตา
                    โดยอาศัยโครงข่ายประสาทเทียมแบบคลื่นสมอง (Convolutional Neural Network - CNN) ผ่านภาษา Python
                    ซึ่งคุณจะได้ฝึกสอนโมเดลคอมพิวเตอร์ให้แยกแยะชนิดของโรคพืช
                    และความเสียหายในสวนทุเรียนเมืองจันท์ได้อย่างแม่นยำดุจนักวิจัยตัวจริง!
                </p>
            </div>

            <div class="pull-quote">
                "Vision is not just capturing light; it is extracting meaning. We teach machines how to see, so humanity
                can thrive."
            </div>
        ...
        <section class="page">
            ...
            <h2 class="mag-title">Cloud GPU: ขุมพลังการเทรน AI บนฟากฟ้า</h2>

            <div class="cloud-lab-hero">
                <div>
                    <h3 style="font-size: 2.2rem; font-weight: 900; margin-bottom: 1rem; letter-spacing: 2px;">Powered
                        by TensorFlow & GPU</h3>
                    <p style="max-width: 550px; font-weight: 300;">
                        ดึงทักษะประมวลผลภาพระดับอุตสาหกรรมข้ามโลกมาไว้ในห้องเรียนคุณ
                        ฟรีโดยไม่ต้องจัดซื้อคอมพิวเตอร์เครื่องเก่ง</p>
                </div>
            </div>

            <div class="magazine-columns">
                <p>
                    หัวใจของการสร้างและเทรนโมเดล AI ภาพ (Deep Learning) คือพลังการคำนวณขั้นสูง เราเลือกให้คุณใช้งานผ่าน
                    <strong>Google Colab พร้อมคอร์ GPU เสมือน (Tesla T4 / A100)</strong>
                    ที่ช่วยลดเวลาจากแรมวันให้เหลือเพียงไม่กี่วินาทีบนเบราว์เซอร์
                </p>
                <p>
                    <strong>วิธีการเริ่มต้นเทรนตาทิพย์:</strong><br>
                    1. ล็อกอินเข้า Google Colab และเปลี่ยน Runtime เป็น GPU<br>
                    2. อิมพอร์ตไลบรารี TensorFlow และ Keras<br>
                    3. โหลดคลังภาพ Dataset รูปใบไม้ที่เราเตรียมให้<br><br>
                    <em>เคล็ดลับความสำเร็จ: การทดสอบจำลอง Hyperparameter และ Epochs ที่กล้ายอมรันให้เกิดผลลัพธ์ผิดพลาด
                        จะสร้างประสบการณ์ล้ำค่าที่สุด</em>
                </p>
            </div>
            ...
            <div class="tech-insight">
                ...
                <ul style="padding-left: 1.5rem; font-size: 0.9rem;">
                    ...
                    <li>Dataset: <code>leaf_disease_dataset.zip</code> (10,000+ ภาพ)</li>
                    <li>Basic knowledge of Pixels & Matrices</li>
                </ul>
            </div>
        </section>
