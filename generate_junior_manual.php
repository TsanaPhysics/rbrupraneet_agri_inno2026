...
<head>
    ...
    <style>
        ...
        body { font-family: "THSarabunNew", "DejaVu Sans", sans-serif; line-height: 1.6; color: #333; font-size: 16px; }
        .cover { text-align: center; padding-top: 150px; page-break-after: always; }
        .title { font-size: 32px; font-weight: bold; color: #0284c7; margin-bottom: 10px; }
        .subtitle { font-size: 18px; color: #666; }
        .section-title { font-size: 22px; font-weight: bold; border-bottom: 2px solid #0284c7; padding-bottom: 5px; margin-top: 30px; color: #0369a1; page-break-before: always; }
        .session-card { margin-bottom: 15px; padding: 10px; border: 1px solid #eee; border-radius: 8px; }
        .session-title { font-weight: bold; color: #0284c7; font-size: 16px; }
        .code-block { background: #f0f9ff; padding: 8px; font-family: monospace; font-size: 11px; border-radius: 5px; white-space: pre-wrap; color: #0c4a6e; }
...
<body>
    ...
    <div class="cover">
        <h1 class="title">คู่มือนวัตกรรมเกษตรดิจิทัล (มัธยมต้น)</h1>
        <p class="subtitle">Agri-Innovation Curriculum: Junior High Edition</p>
        <p style="margin-top: 50px;">เน้นพื้นฐานตรรกะและการสำรวจเทคโนโลยี</p>
        <p>ศูนย์พัฒนานวัตกรรมเกษตรดิจิทัลรำไพพรรณี-ประณีตวิทยาคม</p>
    </div>

    <h2 class="section-title">Track 1: Climate Data Hacking (ม.ต้น)</h2>
';
...
$html .= '<h2 class="section-title">Track 2: Deep Dive Lab (AI-CNN) (ม.ต้น)</h2>';
...
$html .= '<h2 class="section-title">Track 3: AI-IoT Prototyping (ม.ต้น)</h2>';
...
$dompdf->stream("Agri_Inno_Junior_Manual.pdf", array("Attachment" => 0));
?>
